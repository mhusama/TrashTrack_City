...
export default function EditReportPage() {
    ...
    return (
      <div className="card p-8 text-center">
        <p className="text-black">
          This report can no longer be edited because it has been resolved or rejected.
        </p>
        <Link
          to={`/reports/${id}`}
          className="link-inline mt-4 inline-block"
        >
          View report
        </Link>
      </div>
  ...
  return (
    <div className="new-report-page w-full text-black">
      ...
      <h1 className="mb-6 text-2xl font-bold text-black">Edit report</h1>
      <ReportForm
        initialData={report}
