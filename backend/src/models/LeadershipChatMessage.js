...
const leadershipChatMessageSchema = new mongoose.Schema(
  {
    sender: {
...
export const LeadershipChatMessage = mongoose.model(
  "LeadershipChatMessage",
  leadershipChatMessageSchema
);
